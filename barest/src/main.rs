//after setting path to the environmental variable thing, if vs code is open, restart it
...
static HELLO: &[u8] = b"Hello World! Chima has just written his first kernel without host OS";
